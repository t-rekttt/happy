...
export const pt: TranslationStructure = {
    ...
    machineClaudeSessions: {
        ...
        link: "Retomar uma sessão do Claude",
        footer: "Sessões iniciadas com a CLI do Claude nesta máquina. Toque em uma para retomá-la no Happy.",
        empty: "Nenhuma sessão do Claude encontrada nesta máquina.",
        adoptFailed: "Falha ao retomar a sessão.",
    },
    machineLauncher: {
    ...
    settingsVoice: {
        ...
        providerDescription: "Escolha o backend de voz. A opção auto-hospedada usa seu próprio servidor LiveKit e agente em vez do ElevenLabs.",
        selfHostedTitle: "Voz auto-hospedada",
        selfHostedSubtitle: "Use seu próprio servidor LiveKit e agente",
